...
Table \ref{tab:duration_reg} shows the effect of case-characteristics on the duration of the case (in days). The state in which the case is filed has a large and statistically significant effect on the duration of the case. % Cases in Delhi appear to take longer than cases in other states. Haryana, Punjab, Chandigarh and Gujarat appear to dispose cases faster than the other states and
% \glspl{ut}.
